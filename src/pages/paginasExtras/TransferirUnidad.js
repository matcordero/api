...
const TransferirUnidad = () => {
    ...
    },
    {
      ...
      name:"documento",
      type:"int",
      placeholder:"Ingrese el Documento del Nuevo Dueño",
      label:"Nuevo Dueño",
      required:true
    },
    ...
    const handleSubmit = (e) => {
        ...
        fetch('http://localhost:8080/TPOAPI/Controller/PutTransferirUnidad'+"/"+values.codigoEdificio+"/"+values.piso+"/"+values.numeroUnidad+"/"+values.documento, {
        method: 'PUT',
        body: formData,
        mode: "cors"
    })
    ...
    return( 
        <div className="app"> 
            <form className='form-RegistrarPersona' onSubmit={handleSubmit}>
                <h1 className='h1-RegistrarPersona' >Transferir Unidad</h1>
                {inputs.map((input)=> (
