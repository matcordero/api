...
const AgregarDuenioInquilino = () => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch('http://localhost:8080/TPOAPI/Controller/PutAgregarDuenioInquilino'+"/"+values.codigoEdificio+"/"+values.piso+"/"+values.numeroUnidad+"/"+values.documento, {
        method: 'PUT',
        body: formData,
        mode: "cors"
    })
    .then(function(response) {
        ...
        alert("Alquilar Unidad Completado");
    ...
    return( 
        <div className="app"> 
            <form className='form-RegistrarPersona' onSubmit={handleSubmit}>
                <h1 className='h1-RegistrarPersona' >Agregar Dueño Inquilino</h1>
                {inputs.map((input)=> (
...
export default AgregarDuenioInquilino;