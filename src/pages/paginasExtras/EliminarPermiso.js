...
const EliminarPermiso = () => {
    ...
    },
    {
        ...
        name:"permiso",
        type:"text",
        placeholder:"Ingrese el Permiso quitar",
    ...
    const handleSubmit = (e) => {
        ...
        fetch('http://localhost:8080/TPOAPI/Controller/PutQuitarPermiso', {
        method: 'PUT',
        body: formData,
        mode: "cors"
    })
    ...
    return( 
        <div className="app"> 
            <form className='form-RegistrarPersona' onSubmit={handleSubmit}>
                <h1 className='h1-RegistrarPersona' >Eliminar Permiso</h1>
                {inputs.map((input)=> (
