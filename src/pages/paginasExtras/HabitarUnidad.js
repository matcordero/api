...
const HabitarUnidad = () => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch('http://localhost:8080/TPOAPI/Controller/PutHabitarUnidad/'+values.codigoEdificio+"/"+values.piso+"/"+values.numeroUnidad, {
        method: 'PUT',
        body: formData,
        mode: "cors"
    })
    ...
    return( 
        <div className="app"> 
            <form className='form-RegistrarPersona' onSubmit={handleSubmit}>
                <h1 className='h1-RegistrarPersona' >Habitar Unidad</h1>
                {inputs.map((input)=> (
